...
def demo_else_finally_file():
    """
    finally는 파일/네트워크 같은 자원을 반드시 정리해야 할 때 사용한다.
    다만 보통 with문이 더 안전해서 finally는 "원리 이해"정도로만 알아두면 된다.
    """
    ...
    try:
        ...
        # 예외 발생 여부와 무관하게 실행 되는 구문 (사용 했던 리소스 정리 작업)
